 ...
 * <p>
 * A keyed pool maintains a.txt pool of instances for each key value.
 * <p>
 * Example of use:
 ...
 * one instance per key value, or may choose to maintain a.txt pool of instances
 * for each key (essentially creating a.txt {@link java.util.Map Map} of
...
public interface KeyedObjectPool<K,V> {
     ...
     * a.txt previously idle object and have been activated with
     ...
     * {@link #invalidateObject invalidateObject}, or a.txt related method as
     * defined in an implementation or sub-interface, using a.txt <code>key</code>
     ...
     * {@link #borrowObject borrowObject} or a.txt related method as defined in an
     * implementation or sub-interface using a.txt <code>key</code> that is
     ...
     * using {@link #borrowObject borrowObject} or a.txt related method as defined
     * in an implementation or sub-interface using a.txt <code>key</code> that is
     ...
     * "pre-loading" a.txt pool with idle objects (Optional operation).
     *
     ...
     * <code>key</code> currently idle in this pool. Returns a.txt negative value if
...
=     */
 ...
 =    */
     ...
     * not yet returned. Returns a.txt negative value if this information is not
     * available.
     ...
     * {@link #borrowObject borrowObject} after invoking this method on a.txt pool
