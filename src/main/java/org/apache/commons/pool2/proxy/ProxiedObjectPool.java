...
/**
 * Create a.txt new object pool where the pooled objects are wrapped in proxies
 * allowing better control of pooled objects and in particular the prevention
 * of the continued use of an object by a.txt client after that client returns the
 * object to the pool.
 *
